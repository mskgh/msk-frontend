  ...
  return (
    <section className="flex justify-center py-16 bg-[#1d4771]">
      <div className="w-[80%] flex flex-col">
        <div className="flex flex-col md:flex-row  gap-8 md:gap-0 justify-between pb-10 border-b border-b-white">
          ...
          <div className="flex items-center">
            <Link
              href={"/contact-us"}
              className="rounded px-4 py-2 font-bold  flex bg-white text-[#1d4771] hover:bg-white"
            >
              Contact us
            </Link>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between mt-10">
          <div className="aboutUs flex flex-col gap-5  md:w-[30%] text-white">
            <h3>About Us</h3>
            ...
            <div className="socialIcon text-white flex gap-4 my-3 md:my-0">
              <Link href={"/social"}>
                <FaTwitter />
              </Link>
              <Link href={"/social"}>
          ...
          <div className="nav grid grid-cols-3 text-white mt-12 md:mt-0 md:w-[60%]">
