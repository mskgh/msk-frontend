          ...
          >
            <ul className="flex flex-col gap-y-2 list-none mt-5">
              <li className="flex items-center justify-around px-3 py-1 activeOr">
                <span className="nameIcon">C</span>
                {!hideSideNav && (
                  <span className="font-bold ">Company one</span>
                )}
              </li>

              <li className="flex items-center justify-around px-3 py-1 ">
                <span className="nameIcon">C</span>
                {!hideSideNav && <span className="">Company two</span>}
              </li>
            </ul>
            <div className="flex w-[90%] mx-auto border shadow mb-2 justify-between sidebar--footer">
              <button
                onClick={showModal}
                className="w-full flex justify-around p-1"
              >
                <VscOrganization className="text-2xl" />
                {!hideSideNav && <p>New Organization</p>}
              </button>
            </div>
          </div>
          ...
          >
            <ul className="flex flex-col gap-y-2 list-none mt-5">
              <li className="flex items-center justify-around px-3 py-1 bg-[#2d5b88]">
                <span className="nameIcon">C</span>
                {hideSideNav && <span className="font-bold ">Company one</span>}
              </li>
